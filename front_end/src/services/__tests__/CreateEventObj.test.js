...
test("single date event object created successfully", () => {
    const test_event = {
        id: 1,
...
test("multiple date event object created successfully", () => {
    const test_event = {
        id: 1,
        event_name: "Cosmic Insanity",
        event_details: "Hell of a trip man",
    ...
    console.log(test_event_object[0].start.dateTime)
    ...
    console.log(test_event_object[1].start.dateTime)
